<section class="section section-md bg-image bg-primary bg-fixed" style="background-image: url(/wp-content/themes/kim-marinoff/images/bg-02-1920x1200.jpg)">
    <div class="shell text-center text-lg-left">
      ...
      <h4 class="text-light reveal-lg-inline-block text-middle inset-lg-right-60">We provide expert financial advice for businesses and individuals</h4>
      <a href="our-services.html" class="button button-sm button-primary-filled text-middle">See All Services</a> </div>
  </section>	
